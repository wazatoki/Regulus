...
type QueryCondition struct {
	...
	PatternName   string      `db:"pattern_name" boil:"pattern_name" json:"pattern_name" toml:"pattern_name" yaml:"pattern_name"`
	CategoryName  string      `db:"category_name" boil:"category_name" json:"category_name" toml:"category_name" yaml:"category_name"`
	IsDisclose    bool        `db:"is_disclose" boil:"is_disclose" json:"is_disclose" toml:"is_disclose" yaml:"is_disclose"`
	OwnerID       string      `db:"owner_id" boil:"owner_id" json:"owner_id" toml:"owner_id" yaml:"owner_id"`

	R *queryConditionR `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L queryConditionL  `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
var QueryConditionTableColumns = struct {
	ID            string
	Del           string
	CreatedAt     string
	CreStaffID    string
	...
	ID:            "query_conditions.id",
	Del:           "query_conditions.del",
	CreatedAt:     "query_conditions.created_at",
	CreStaffID:    "query_conditions.cre_staff_id",
	UpdatedAt:     "query_conditions.updated_at",
	UpdateStaffID: "query_conditions.update_staff_id",
	PatternName:   "query_conditions.pattern_name",
	CategoryName:  "query_conditions.category_name",
	IsDisclose:    "query_conditions.is_disclose",
	OwnerID:       "query_conditions.owner_id",
}
...
var QueryConditionWhere = struct {
	...
	Del:           whereHelperbool{field: "\"query_conditions\".\"del\""},
...
type queryConditionR struct {
	CreStaff                  *Staff                        `db:"CreStaff" boil:"CreStaff" json:"CreStaff" toml:"CreStaff" yaml:"CreStaff"`
	Owner                     *Staff                        `db:"Owner" boil:"Owner" json:"Owner" toml:"Owner" yaml:"Owner"`
	UpdateStaff               *Staff                        `db:"UpdateStaff" boil:"UpdateStaff" json:"UpdateStaff" toml:"UpdateStaff" yaml:"UpdateStaff"`
	...
	QueryDisplayItems         QueryDisplayItemSlice         `db:"QueryDisplayItems" boil:"QueryDisplayItems" json:"QueryDisplayItems" toml:"QueryDisplayItems" yaml:"QueryDisplayItems"`
	QueryOrderConditionItems  QueryOrderConditionItemSlice  `db:"QueryOrderConditionItems" boil:"QueryOrderConditionItems" json:"QueryOrderConditionItems" toml:"QueryOrderConditionItems" yaml:"QueryOrderConditionItems"`
	QuerySearchConditionItems QuerySearchConditionItemSlice `db:"QuerySearchConditionItems" boil:"QuerySearchConditionItems" json:"QuerySearchConditionItems" toml:"QuerySearchConditionItems" yaml:"QuerySearchConditionItems"`
}
...
type (
	...
	// This should almost always be used instead of []QueryCondition.
...
func (o *QueryCondition) Staffs(mods ...qm.QueryMod) staffQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"favorite_conditions\" on \"staffs\".\"id\" = \"favorite_conditions\".\"staffs_id\""),
		qm.Where("\"favorite_conditions\".\"query_conditions_id\"=?", o.ID),
	)
...
func (queryConditionL) LoadStaffs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeQueryCondition interface{}, mods queries.Applicator) error {
	var slice []*QueryCondition
	var object *QueryCondition
	...
	query := NewQuery(
		qm.Select("\"staffs\".id, \"staffs\".del, \"staffs\".created_at, \"staffs\".cre_staff_id, \"staffs\".updated_at, \"staffs\".update_staff_id, \"staffs\".account_id, \"staffs\".password, \"staffs\".name, \"a\".\"query_conditions_id\""),
		qm.From("\"staffs\""),
		qm.InnerJoin("\"favorite_conditions\" as \"a\" on \"staffs\".\"id\" = \"a\".\"staffs_id\""),
...
func (queryConditionL) LoadStaffGroups(ctx context.Context, e boil.ContextExecutor, singular bool, maybeQueryCondition interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"staff_groups\".id, \"staff_groups\".del, \"staff_groups\".created_at, \"staff_groups\".cre_staff_id, \"staff_groups\".updated_at, \"staff_groups\".update_staff_id, \"staff_groups\".name, \"a\".\"query_conditions_id\""),
...
func (queryConditionL) LoadQueryDisplayItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeQueryCondition interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`query_display_items`),
		qm.WhereIn(`query_display_items.query_conditions_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (queryConditionL) LoadQueryOrderConditionItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeQueryCondition interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`query_order_condition_items`),
		qm.WhereIn(`query_order_condition_items.query_conditions_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (queryConditionL) LoadQuerySearchConditionItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeQueryCondition interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`query_search_condition_items`),
		qm.WhereIn(`query_search_condition_items.query_conditions_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *QueryCondition) AddStaffs(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Staff) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"favorite_conditions\" (\"query_conditions_id\", \"staffs_id\") values ($1, $2)"
...
// Sets o.R.QueryConditions's Staffs accordingly.
// Replaces o.R.Staffs with related.
// Sets related.R.QueryConditions's Staffs accordingly.
func (o *QueryCondition) SetStaffs(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Staff) error {
	query := "delete from \"favorite_conditions\" where \"query_conditions_id\" = $1"
	...
	removeStaffsFromQueryConditionsSlice(o, related)
	if o.R != nil {
		o.R.Staffs = nil
	}
...
func (o *QueryCondition) RemoveStaffs(ctx context.Context, exec boil.ContextExecutor, related ...*Staff) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"favorite_conditions\" where \"query_conditions_id\" = $1 and \"staffs_id\" in (%s)",
...
func removeStaffsFromQueryConditionsSlice(o *QueryCondition, related []*Staff) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
...
func FindQueryCondition(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*QueryCondition, error) {
	...
	if err = queryConditionObj.doAfterSelectHooks(ctx, exec); err != nil {
		return queryConditionObj, err
	}

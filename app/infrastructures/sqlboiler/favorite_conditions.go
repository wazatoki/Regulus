...
var FavoriteConditionTableColumns = struct {
	...
	CategoryName:      "favorite_conditions.category_name",
}
...
var FavoriteConditionWhere = struct {
	...
	CategoryName:      whereHelperstring{field: "\"favorite_conditions\".\"category_name\""},
}
...
var (
	favoriteConditionAllColumns            = []string{"query_conditions_id", "staffs_id", "row_order", "category_name"}
	favoriteConditionColumnsWithoutDefault = []string{"query_conditions_id", "staffs_id", "category_name"}
	favoriteConditionColumnsWithDefault    = []string{"row_order"}

...
var StaffWhere = struct {
	...
	ID:            whereHelperstring{field: "\"staff\".\"id\""},
	Del:           whereHelpernull_Bool{field: "\"staff\".\"del\""},
	CreatedAt:     whereHelpernull_Time{field: "\"staff\".\"created_at\""},
	CreStaffID:    whereHelpernull_String{field: "\"staff\".\"cre_staff_id\""},
	UpdatedAt:     whereHelpernull_Time{field: "\"staff\".\"updated_at\""},
	UpdateStaffID: whereHelpernull_String{field: "\"staff\".\"update_staff_id\""},
	StaffID:       whereHelperstring{field: "\"staff\".\"staff_id\""},
	Password:      whereHelperstring{field: "\"staff\".\"password\""},
	Name:          whereHelperstring{field: "\"staff\".\"name\""},
}
...
var (
	staffAllColumns            = []string{"id", "del", "created_at", "cre_staff_id", "updated_at", "update_staff_id", "staff_id", "password", "name"}
	staffColumnsWithoutDefault = []string{"id", "created_at", "cre_staff_id", "updated_at", "update_staff_id", "staff_id", "password", "name"}
...
func FindStaff(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Staff, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"staff\" where \"id\"=$1", sel,
	)
...
func (o *Staff) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboiler: unable to update staff, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update staff row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by update for staff")
	}
...
func (q staffQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update all for staff")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to retrieve rows affected for staff")
	}
...
func (o *Staff) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to upsert staff")
	}
...
func (o *Staff) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete from staff")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by delete for staff")
	}
...
func (q staffQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete all from staff")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by deleteall for staff")
	}
...
func StaffExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"staff\" where \"id\"=$1 limit 1)"

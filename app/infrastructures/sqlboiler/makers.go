...
type Maker struct {
	...
	R *makerR `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L makerL  `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
var MakerTableColumns = struct {
	...
	ID:            "makers.id",
	Del:           "makers.del",
	CreatedAt:     "makers.created_at",
	CreStaffID:    "makers.cre_staff_id",
	UpdatedAt:     "makers.updated_at",
	UpdateStaffID: "makers.update_staff_id",
	Name:          "makers.name",
}
...
type (
	...
	// This should almost always be used instead of []Maker.
	MakerSlice []*Maker
...
func FindMaker(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Maker, error) {
	...
	if err = makerObj.doAfterSelectHooks(ctx, exec); err != nil {
		return makerObj, err
	}
